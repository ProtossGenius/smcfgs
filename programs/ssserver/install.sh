...
nohup kcptun-server -l :7522 -t "127.0.0.1:9000" -dscp 46 -key srj7758521.  -mtu 1400 -sndwnd 256 -rcvwnd 2048 -mode fast2 -crypt=aes -keepalive=10     > /root/kcptun.log 2>&1 &
